        ...
        public void ExecuteSeed()
        {
            ...
            _context.Categories.AddRange(
                new Category()
                {
                    ...
                    IsDeleted = false,
                    Name = "Movies",
                    CategoryDetail = new CategoryDetail() { ColorValue = "#0000FF", 
                        ColorName = "Blue" }
                },
                new Category()
                {
                    ...
                    IsDeleted = false,
                    Name = "Books",
                    CategoryDetail = new CategoryDetail() { ColorValue = "#FF0000", 
                        ColorName = "Red" }
                },
                new Category()
                {
                    ...
                    IsDeleted = false,
                    Name = "Games",
                    CategoryDetail = new CategoryDetail() { ColorValue = "#008000", 
                        ColorName = "Green" }
                }
            );
