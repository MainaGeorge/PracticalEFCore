...
{
    public partial class SetMinAndMaxValuesOnQuantity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"IF NOT EXISTS(SELECT *
                ...
                BEGIN
                    ALTER TABLE [dbo].[Items] ADD CONSTRAINT CK_Items_Quantity_Minimum CHECK
                (Quantity >= 0)
                END
                ...
                BEGIN
                    ALTER TABLE [dbo].[Items] ADD CONSTRAINT CK_Items_Quantity_Maximum CHECK
                    (Quantity <= 1000)
                END");
